...
/* ClaudeHMI-Sim: la HMI fija su propia fuente en cada widget; esta es solo el
 * fallback. Usamos la Montserrat 14 integrada de LVGL (LV_FONT_MONTSERRAT_14=1). */
...
#define LV_USE_SYSMON   1
    ...
    #define LV_USE_PERF_MONITOR 0   /* MedGuard: overlay tapaba la UI (esquinas) */
     ...
     *     - Requires `LV_USE_SYSMON = 1`*/
    #define LV_USE_MEM_MONITOR 0   /* MedGuard: tapaba el boton "Salir" del sidebar */
